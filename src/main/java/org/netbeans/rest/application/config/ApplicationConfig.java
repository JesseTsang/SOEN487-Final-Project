...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(soen487.client.PaymentServlet.class);
        resources.add(soen487.service.LoggingServiceREST.class);
        resources.add(soen487.service.RetailerService.class);
    }
