...
// Model for DiscountCode entity
    models.DiscountCode = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/Customer_Restful/webresources/entities.discountcode/",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/Customer_Restful/webresources/entities.discountcode/';
            }
    ...
    models.DiscountCodeCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/Customer_Restful/webresources/entities.discountcode/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
